...
},{"./modules/form-validate/form":3,"./modules/sliders":9,"./modules/tabs":10,"./modules/video":11,"./utils/ios-vh-fix":13}],2:[function(require,module,exports){
"use strict";
...
/* global Swiper */
var trainersSliderElement = document.querySelector('.trainers__slider');
function addTabindex() {
  var originalSlides = document.querySelectorAll('.trainers__item:not(.swiper-slide-duplicate)');
